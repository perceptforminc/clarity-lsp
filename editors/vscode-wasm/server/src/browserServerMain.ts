...
import * as wasm from "../../lib/clarity_repl/clarity_repl_bg.wasm";
import * as clarity_repl from "../../lib/clarity_repl";

console.log('running server clarity-vscode');
...
connection.onWillSaveTextDocument(params => saveTextDocumentHandler());
connection.onDidSaveTextDocument(params => saveTextDocumentHandler());
...
function saveTextDocumentHandler() {
	WebAssembly.instantiate;

	connection.console.log("Saving document");
	clarity_repl.init_session("");
}